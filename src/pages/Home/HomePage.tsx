...
import { dummyTopEmotionBands, getTopEmotionBands } from "../../apis/home"
            ...
            <div className="w-103 h-203 pl-6.5 pr-6.5 overflow-y-scroll bg-[#FBF6F7]">
                ...
                <div className="mt-2.5">
                    <div className="flex justify-between">
                        ...
                        <div className="w-12 h-6 px-2 py-1 bg-stone-300 rounded-[20px] inline-flex justify-center items-center gap-2.5">
                            <div className="justify-start text-stone-600 text-[11px] font-normal font-['SF_Pro'] leading-none">실시간</div>
                        </div>
                    </div>
                ...
                <div>
                    <div className="flex justify-between mt-3.5">
                        ...
                        <div className="w-12 h-6 px-2 py-1 bg-stone-300 rounded-[20px] inline-flex justify-center items-center gap-2.5">
                            <div className="justify-start text-stone-600 text-[11px] font-normal font-['SF_Pro'] leading-none">{topBands !== undefined ? topBands.popularBands.length : "~"}개</div>
                        </div>
                    </div>
