            ...
            <div className="flex flex-col h-[853px] items-center">
                ...
                <div className="w-[412px] flex justify-between pl-6 pr-6 mb-6">
                    ...
                    <div data-has-icon-end="false" data-has-icon-start="true" data-size="Medium" data-state="Default" data-variant="Primary"
                        ...
                        <div className="justify-start text-Text-Brand-On-Brand text-base font-normal font-['Inter'] leading-none">음악</div>
                    </div>
                    ...
                    <div data-has-icon-end="false" data-has-icon-start="true" data-size="Medium" data-state="Default" data-variant="Primary"
                        ...
                        <div className="justify-start text-pink-400 text-base font-normal font-['Inter'] leading-none">코멘트</div>
                    </div>
                    ...
                    <div data-has-icon-end="false" data-has-icon-start="true" data-size="Medium" data-state="Default" data-variant="Primary"
                        ...
                        <div className="justify-start text-cyan-800 text-base font-normal font-['Inter'] leading-none">보관</div>
                    </div>
                </div>
